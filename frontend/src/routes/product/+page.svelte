...
<main class="min-h-screen">
    <div class="relative flex min-h-[200px] py-6 sm:py-0 dark:bg-gradient-to-b dark:from-stone-950 dark:to-transparent bg-gradient-to-b from-red-400 to-transparent">
    ...
    {#each $products as product}
      <div class="w-[350px] rounded-xl overflow-hidden">
        ...
        <div class="relative dark:text-white p-4 pr-20 dark:bg-gray-900 bg-accert">
            ...
            <button
                class="absolute right-4 top-4 bg-red-200 drop-shadow-lg dark:bg-gray-800 rounded-xl w-[50px] h-[50px] flex items-center justify-center text-xl transition duration-500 ease-in-out hover:bg-red-500 dark:hover:bg-gray-700 cursor-pointer"
